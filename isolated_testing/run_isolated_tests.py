...
Usage:
    python isolated_testing/run_isolated_tests.py [config_file]
...
from isolated_testing.isolated_url_extraction_test import IsolatedUrlExtractionTester
...
def main():
    ...
    output_dir = config.get("output_dir", "isolated_testing/output")
