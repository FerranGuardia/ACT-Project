...
logger = get_logger("isolated_tester")
...
class IsolatedUrlExtractionTester:
    ...
    def _generate_default_filename(self, toc_url: str) -> str:
        ...
        return f"isolated_testing/output/{novel_name}_chapter_urls.txt"


def main():
    """Main entry point for isolated testing."""
    if len(sys.argv) < 2:
        print("Usage: python isolated_testing/isolated_url_extraction_test.py <toc_url> [output_file]")
        print("\nExample:")
        print("  python isolated_testing/isolated_url_extraction_test.py https://novelfull.net/black-tech-internet-cafe-system.html")
        print("  python isolated_testing/isolated_url_extraction_test.py https://novelfull.net/black-tech-internet-cafe-system.html custom_output.txt")
        return 1
