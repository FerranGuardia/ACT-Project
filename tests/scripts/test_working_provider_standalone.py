"""Test edge_tts_working provider standalone (no HF demo dependency)"""
import sys
import asyncio
...
async def test():
    """Test EdgeTTSWorkingProvider standalone"""
    print("=" * 60)
    print("Testing Edge TTS Working Provider (Standalone)")
    print("=" * 60)
    print()
    ...
    test_text = "Hello, this is a test of the Edge TTS Working provider using the standalone method."
    
    output_path = Path.home() / "Desktop" / "test_working_standalone.mp3"
...
if __name__ == "__main__":
    try:
        ...
        print("\n" + "=" * 60)
        if success:
            print("[PASS] Edge TTS Working provider test PASSED!")
        else:
            print("[FAIL] Edge TTS Working provider test FAILED")
        print("=" * 60)
