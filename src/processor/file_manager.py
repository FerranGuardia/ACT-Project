...
class FileManager:
    ...
    def _create_directories(self) -> None:
        ...
        directories = [self.project_dir, self.text_dir, self.audio_dir, self.metadata_dir]
    ...
    def save_text_file(self, chapter_num: int, content: str, title: Optional[str] = None) -> Path:
        """
    ...
    def save_audio_file(self, chapter_num: int, audio_path: Path, title: Optional[str] = None) -> Path:
        """
