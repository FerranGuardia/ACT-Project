...
# Deprecation warning
warnings.warn("TTSUtils is deprecated. Use the new architecture components instead.", DeprecationWarning, stacklevel=2)
...
class TTSUtils:
    ...
    def get_speech_params(
        self, rate: Optional[float] = None, pitch: Optional[float] = None, volume: Optional[float] = None
