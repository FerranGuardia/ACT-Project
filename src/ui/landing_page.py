...
class LandingPage(QWidget):
    ...
    def setup_ui(self):
        ...
        main_layout = LayoutHelper.create_vertical(
            spacing=LandingPageConfig.MAIN_SPACING, margins=LandingPageConfig.MAIN_MARGINS
        )
        ...
        # Cards section
        self.cards_section = CardsSection(modes_config=MODES_CONFIG, navigation_callback=self.navigate_to_mode)
