...
class CardTitle(ClickableLabel):
    ...
    def setup_title(self):
        ...
        font = QFont(get_font_family(), LandingPageConfig.CARD_TITLE_FONT_SIZE, QFont.Weight.Bold)
        self.setFont(font)
...
class GenreCard(QFrame):
    ...
    def setup_ui(self, title: str, description: str, icon: Optional[str]):
        ...
        card_layout = LayoutHelper.create_horizontal(
            spacing=LandingPageConfig.CARD_SPACING, margins=LandingPageConfig.CARD_MARGINS
        )
        ...
        # Text content
        text_layout = LayoutHelper.create_vertical(spacing=LandingPageConfig.TEXT_SPACING, margins=(0, 0, 0, 0))
