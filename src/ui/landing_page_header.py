...
class LandingPageHeader(QWidget):
    ...
    def setup_header(self):
        ...
        layout = LayoutHelper.create_vertical(
            spacing=LandingPageConfig.HEADER_SPACING,
            margins=LandingPageConfig.HEADER_MARGINS
        )
            ...
            if not pixmap.isNull():
                ...
                if pixmap.height() > LandingPageConfig.LOGO_MAX_HEIGHT:
                    pixmap = pixmap.scaledToHeight(
                        LandingPageConfig.LOGO_MAX_HEIGHT,
                        Qt.TransformationMode.SmoothTransformation
                    )
                elif pixmap.width() > LandingPageConfig.LOGO_MAX_WIDTH:
                    pixmap = pixmap.scaledToWidth(
                        LandingPageConfig.LOGO_MAX_WIDTH,
                        Qt.TransformationMode.SmoothTransformation
                    )
    ...
    def add_title_section(self, layout: QVBoxLayout):
        ...
        title_container = LayoutHelper.create_vertical(
            spacing=LandingPageConfig.TITLE_CONTAINER_SPACING,
            margins=(0, 0, 0, 0)
        )
        ...
        title_font = QFont(
            get_font_family(),
            LandingPageConfig.TITLE_FONT_SIZE,
            QFont.Weight.Bold
        )
