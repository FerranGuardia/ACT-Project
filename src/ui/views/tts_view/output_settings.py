...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QLineEdit, QComboBox, QGroupBox

from ui.styles import get_line_edit_style, get_combo_box_style, get_group_box_style, COLORS
